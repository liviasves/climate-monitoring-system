...
/**
 * Menu principal do sistema, com opções de login, cadastro e listagem de usuários.
 * Segue o princípio SRP ao ter apenas a responsabilidade de gerenciar o menu principal.
